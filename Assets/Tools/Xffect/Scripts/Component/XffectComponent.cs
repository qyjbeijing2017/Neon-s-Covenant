...
namespace Xft
{
    ...
    {
        #region Member
        static public string CurVersion = "5.2.0";
        public string MyVersion = "5.2.0";
        ...
        void Start()
        {
            ...
            //NOTE:
            //djfrail found a bug that EffectLayer could not be inited correctly, so i use this trick to check it.
            //not sure if it works.
            //if (!CheckEditModeInited())
            //{
            //.Log("Find a xffect that is not inited properbly:" + gameObject.name + ". Please use Active() to activate this xffect.");
            Initialize();
            //}
        ...
        public List<EffectLayer> EffectLayerList
        {
            get
            {
                return EflList;
